...
class LazyLocalSearchHelper(object):
  ...
  def __init__(self, model, args, **kwargs):
    """Initialize lazy local search helper
  ...
  def _perturb_image(self, image, noise):
    ...
    Args:
      ...
      noise: numpy array with size [1, 32, 32, 3]
    
    Returns:
      adv_image: numpy array with size [1, 32, 32, 3], perturbed image 
    """
  ...
  def _flip_noise(self, noise, block):
    ...
    Returns:
      noise_new: numpy array with size [1, 32, 32, 3], updated noise
    """
